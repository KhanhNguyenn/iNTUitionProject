...
<link href="loginByFace.css" rel="stylesheet" type="text/css">
</head>
<body>
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading" style="position: absolute;top:120px;left:50%;transform: translate(-50%)">Login Page </div>
            <div class="userloginheading" style="position: absolute;top:160px;left:50%;transform: translate(-50%);background-color: aqua">Do you want to login by face or pass? </div>

            <p>Note: Account doesn't exist</p>
          </div>
