...
<div class="container">
 ...
 <h1 style="text-align: left;">Encryption Page</h1>

	<b>Error: You are just be able to pass message by one of two methods !!!</b>
	
	<form action="Encode" method="POST" enctype="multipart/form-data">
		Enter text to encode:<br>
		<span class="tab"><input type="textbox" name="script_text" style="width:360;height:30"><br></span>
		<br>
		Enter key:<br>
		<span class="tab"><input type="textbox" name="key" style="width:360;height:30"><br></span>
		<br>
		 Or upload file here to encode:<br>
		<input type="file" name="script_file" value="script_file" style="width:360;height:30"> <br> 
		<br><br>
