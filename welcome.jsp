     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading"></div>
            <br>
	   <a href="EncryptionGame.jsp" style="position: absolute;left: 50%; top: 74%; transform: translate(-50%,-50%);">Encryption Game</a>



	   <a href="SnakeGame.jsp" style="position: absolute;left: 50%; top: 82%; transform: translate(-50%,-50%);" >Snake Game</a>

	   <form action="Logout" method="GET">
		  <input type="submit" value="logout" style="margin:20px;padding-left: 5px;position: absolute;left: 47%; top: 90%; transform: translate(-50%,-50%);">
	   </form>
