...
<link href="auth-image.css" rel="stylesheet" type="text/css">
</head>
<body>
  <%
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading" style="position: absolute;left: 50%;top:20%;transform: translate(-50%,-50%); background-color: salmon">Do you want to take a photo to login by face</div>
          </div>
