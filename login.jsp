...
<body>
  ...
  <div class="box" style="-moz-background-size:cover;-webkit-background-size:cover;background-size:cover;background-attachment:fixed;-o-background-size:cover">
<svg version="1.1" id="BACKGROUND" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 750 500" style="enable-background:new 0 0 750 500;background-size:cover;" xml:space="preserve">
<style type="text/css">
...
<div class="container">
  <div class="login-contianer">
      <div class="bg_top">
        <h3 class="welcome">Welcome to our Page</h3>
        <p class="subtext">
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          <div class="userloginheading" style="position:absolute;left:50%;transform:translate(-50%); color: brown;background-color: skyblue;">Do you want to login by password or face?</div>
          </div>

	<div class="form-group row">
	 <div class="col-sm-12 width100 mt40 text-center">
		 <form action="loginByPass.jsp" method="GET">
			 <input type="submit" value="By Pass">
		 </form>
 </div>
