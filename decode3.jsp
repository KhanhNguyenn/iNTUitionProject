...
<link href="decode.css" rel="stylesheet" type="text/css">
</head>
<body>
  <%
...
<div class="container">
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading" style="position: absolute;left: 50%;top:20%;transform: translate(-50%); color:brown">DECRYPTION PAGE</div>
          </div>
  ...
  <div class="form-group row">
	...
	<br>
	<%
		File tempFile= new File((String)session.getAttribute("textPath"));
	...
	%>
        ...
        <br>
	<a type="button" href="decode2.jsp">Hide script text</a>
